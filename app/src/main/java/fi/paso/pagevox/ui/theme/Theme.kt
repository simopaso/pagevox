...
fun PageVoxTheme(
    ...
    // Material You dynamic color is available on Android 12+ and is the
    // recommended default per the current Material 3 guidelines.
    ...
    if (!view.isInEditMode) {
        SideEffect {
            ...
            // Edge-to-edge is enabled in MainActivity; here we only set the
            // system-bar icon contrast so they stay legible over app content.
